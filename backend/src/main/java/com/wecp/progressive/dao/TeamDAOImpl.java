...
public class TeamDAOImpl implements TeamDAO{
    ...
    public Team getTeamById(int teamId) throws SQLException{
        ...
        try 
        {
            ...
            if(resultSet.next())
            {
                ...
                String locattion = resultSet.getString("location");
                String ownerName = resultSet.getString("owner_name");
                int establishmentYear = resultSet.getInt("establishment_year");
                return new Team(teamId, teamName, locattion, ownerName, establishmentYear);
    ...
    public List<Team> getAllTeams() throws SQLException {
        ...
        while(resultSet.next())
        {
            ...
            String ownerName = resultSet.getString("owner_name");
            int establishmentYear = resultSet.getInt("establishment_year");
            teams.add(new Team(teamId, teamName, locattion, ownerName, establishmentYear) );
